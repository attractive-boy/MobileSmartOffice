...
public class CodeGenerator {
     ...
     * 数据库连接字符
     */
    private static final String URL = "jdbc:mysql://47.115.206.168:3306/mobilesmartoffice?serverTimezone=UTC";

    /**
     * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
     */
    private static final String PARENT_PACKAGE_NAME = "com.mobile.smartoffice";
     ...
     * 数据库密码
     */
    private static final String PASSWORD = "404NotFound";
    /**
     * 项目根路径
     */
    //C:\Users\DELL\Desktop\MobileSmartOffice\spring-back
